...
ARG_DEFINITIONS = {
    ...
    'SQL_COLUMNS': 'Comma-seperated list off column names to sync.',
    'AK_USEFIELDS': 'Comma-separted list of usefield names, in same order as mapped SQL_COLUMNS.'
}

REQUIRED_ARGS = [
    'AK_BASEURL', 'AK_USER', 'AK_PASSWORD', 'DB_HOST', 'DB_PORT', 'DB_USER',
    'DB_PASS', 'DB_NAME', 'SQL_FILE', 'SQL_LIMIT', 'SQL_COLUMNS', 'AK_USEFIELDS'
]
...
def sync(args):
    ...
    userfields = args.AK_USEFIELDS.split(',')
    for row in rows:
        key_values = {
